...
from audit_hunter.threat_model import ThreatModelError, generate_threat_model
...
def threat_model_command(repo: str, run_id: str | None, reports_dir: str | None) -> None:
