...
# Gapfill defaults to a modest number — large counts amplify token usage
...
async def run_gapfill(ctx: StageContext, db: StateDB,
    ...
    for t in completed:
        hunt_result = t.raw_json.get("_hunt_result") or {}
        gaps_by_task[t.task_id] = hunt_result.get("gaps_observed") or []
